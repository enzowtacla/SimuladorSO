...
__all__ = ['Interface', 'SO', 'Tarefa', 'Evento', 'EscalonadorFIFO', 'EscalonadorPRIOP', 'EscalonadorSRTF', 'ModalConfigManual', 'ModalTarefas', 'ModalEvent', 'ModalAjuda', 'CORES_TAREFAS', 'COR_TAREFA_NAO_EXECUTANDO', 'get_cor_nome', 'get_cor_hex', 'get_lista_cores_para_combobox', 'extrair_id_cor_do_texto']